dockerize ![version v1.0.0](https://img.shields.io/badge/version-v1.0.0-brightgreen.svg) ![License MIT](https://img.shields.io/badge/license-MIT-blue.svg)
=============
...
* [linux/amd64](https://github.com/jwilder/dockerize/releases/download/v1.0.0/dockerize-linux-amd64-v1.0.0.tar.gz)
* [alpine/amd64](https://github.com/jwilder/dockerize/releases/download/v1.0.0/dockerize-alpine-linux-amd64-v1.0.0.tar.gz)
* [darwin/amd64](https://github.com/jwilder/dockerize/releases/download/v1.0.0/dockerize-darwin-amd64-v1.0.0.tar.gz)
